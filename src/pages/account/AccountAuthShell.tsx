...
export function AccountAuthShell({
  ...
  return (
    <section className="relative overflow-hidden bg-[#F6F6F2] z-[70] pt-[168px] pb-20 px-6 lg:px-12 min-h-[70vh] lg:pt-[184px]">
      ...
      <div className="relative max-w-5xl mx-auto grid gap-8 lg:grid-cols-[0.9fr_1.1fr] items-start">
        <aside className="relative overflow-hidden border border-[#0B0B0D]/10 bg-white p-6 lg:p-8 shadow-[0_20px_60px_rgba(11,11,13,0.06)]">
        ...
        <div className="relative overflow-hidden border border-[#0B0B0D]/10 bg-white p-4 lg:p-6 min-h-[680px] shadow-[0_20px_60px_rgba(11,11,13,0.06)]">
          <div className="absolute inset-x-0 top-0 h-1 accent-bg" />
          <div className="mt-2 w-full max-w-full overflow-hidden">{children}</div>
        </div>
      </div>
    </section>
  );
